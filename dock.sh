...
dockutil --add ~/Sync/Business/Forerunner\ Games/games/peril/scripts/aaron/peril-scripts --section others --view list --display folder --sort name
dockutil --add ~/Sync/Business/Forerunner\ Games/games/peril/documents/peril-todo.txt --section others
